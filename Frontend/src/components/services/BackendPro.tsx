...
const BackendPro: React.FC = () => {
    ...
    return (
        ...
        <div  key={product.product_id} className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg dark:bg-gray-950">
          <img
